...
template<class T, class H = splitmix64_hash> using uset = std::unordered_set<T, H>;
template<class T, class U, class H = splitmix64_hash> using umap = std::unordered_map<T, U, H>;
